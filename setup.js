...
module.exports = function (opts) {
	const TraksContext = React.createContext();

	const T = function (props) {
		return React.createElement(TraksContext.Consumer, {}, function (value) {
			if (value === undefined) {
			...
			if (value.translations[key] && value.translations[key][lang]) {
				...
				return React.createElement(
					value.translation_missing_component,
					{},
					props.children
				);
			} else {
	...
	const TraksConsumer = function (props) {
		return React.createElement(TraksContext.Consumer, {}, function (value) {
			if (value === undefined) {
				throw new Error(
					"<TraksConsumer> tag not used inside <TraksProvider/>"
				);
			}
